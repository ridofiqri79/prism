...
export const loanAgreementRoutes: RouteRecordRaw[] = [
  {
    ...
    meta: { requiresAuth: true, permission: { module: 'loan_agreement', action: 'read' } },
  },
  {
    path: 'loan-agreements/new',
    name: 'loan-agreement-create',
    component: () => import('@/pages/loan-agreement/LAFormPage.vue'),
    meta: { requiresAuth: true, permission: { module: 'loan_agreement', action: 'create' } },
  },
  {
  ...
  },
  {
    ...
    component: () => import('@/pages/loan-agreement/LAFormPage.vue'),
    meta: { requiresAuth: true, permission: { module: 'loan_agreement', action: 'update' } },
  },
]
