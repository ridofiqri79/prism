...
export const blueBookRoutes: RouteRecordRaw[] = [
  {
    ...
    meta: { requiresAuth: true, permission: { module: 'blue_book', action: 'read' } },
  },
  {
    path: 'blue-books/:id',
  ...
  },
  {
    ...
    meta: { requiresAuth: true, permission: { module: 'bb_project', action: 'create' } },
  },
  {
  ...
  },
  {
    ...
    component: () => import('@/pages/blue-book/BBProjectFormPage.vue'),
    meta: { requiresAuth: true, permission: { module: 'bb_project', action: 'update' } },
  },
]
