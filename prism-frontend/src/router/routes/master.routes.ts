...
export const masterRoutes: RouteRecordRaw[] = [
  {
    ...
    meta: {
      requiresAuth: true,
      title: 'Master Negara',
      permission: { module: 'country', action: 'read' },
    },
  },
  {
    path: 'master/lenders',
    ...
    meta: {
      requiresAuth: true,
      title: 'Master Lender',
      permission: { module: 'lender', action: 'read' },
    },
  },
  {
    ...
    meta: {
      requiresAuth: true,
      title: 'Master Institution',
      permission: { module: 'institution', action: 'read' },
    },
  },
  {
    path: 'master/regions',
    ...
    meta: {
      ...
      permission: { module: 'region', action: 'read' },
    },
  },
  {
    ...
    meta: {
      ...
      permission: { module: 'program_title', action: 'read' },
    },
  },
  {
    ...
    meta: {
      requiresAuth: true,
      title: 'Master Bappenas Partner',
      permission: { module: 'bappenas_partner', action: 'read' },
    },
  },
  {
    path: 'master/periods',
    ...
    meta: {
      requiresAuth: true,
      title: 'Master Period',
      permission: { module: 'period', action: 'read' },
    },
  },
  {
    ...
    meta: {
      requiresAuth: true,
      title: 'Master National Priority',
      permission: { module: 'national_priority', action: 'read' },
    },
  },
  {
    ...
    meta: { requiresAuth: true, title: 'Import Data', adminOnly: true },
  },
]
