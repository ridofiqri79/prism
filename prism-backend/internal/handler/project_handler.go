...
func projectMasterFilter(c echo.Context) model.ProjectMasterFilter {
	return model.ProjectMasterFilter{
		...
		DKLenderIDs:            queryValues(c, "dk_lender_ids", "dk_lender_ids[]"),
		LoanAgreementLenderIDs: queryValues(c, "loan_agreement_lender_ids", "loan_agreement_lender_ids[]"),
		DKExecutingAgencyIDs:   queryValues(c, "dk_executing_agency_ids", "dk_executing_agency_ids[]"),
