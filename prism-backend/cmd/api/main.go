...
func main() {
	...
	blueBooks.POST("/import/preview", blueBookHandler.PreviewMultiBlueBookImport, middleware.RequireAdmin())
	blueBooks.POST("/import/execute", blueBookHandler.ImportMultiBlueBook, middleware.RequireAdmin())
	blueBooks.GET("/import/template", blueBookHandler.DownloadMultiBlueBookImportTemplate, middleware.RequireAdmin())
	...
	greenBooks.POST("/import/preview", greenBookHandler.PreviewMultiGreenBookImport, middleware.RequireAdmin())
	greenBooks.POST("/import/execute", greenBookHandler.ImportMultiGreenBook, middleware.RequireAdmin())
	greenBooks.GET("/import/template", greenBookHandler.DownloadMultiGreenBookImportTemplate, middleware.RequireAdmin())
	...
	dk.GET("/import/template", dkHandler.DownloadDKImportTemplate, middleware.RequireAdmin())
	dk.POST("/import/preview", dkHandler.PreviewImportDK, middleware.RequireAdmin())
	dk.POST("/import/execute", dkHandler.ImportDK, middleware.RequireAdmin())
