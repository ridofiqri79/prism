...
func main() {
	...
	dashboardAnalytics := dashboard.Group("/analytics")
	dashboardAnalytics.GET("/overview", dashboardAnalyticsHandler.Overview)
	dashboardAnalytics.GET("/institutions", dashboardAnalyticsHandler.Institutions)
	dashboardAnalytics.GET("/lenders", dashboardAnalyticsHandler.Lenders)
	dashboardAnalytics.GET("/absorption", dashboardAnalyticsHandler.Absorption)
	dashboardAnalytics.GET("/yearly", dashboardAnalyticsHandler.Yearly)
	dashboardAnalytics.GET("/lender-proportion", dashboardAnalyticsHandler.LenderProportion)
	dashboardAnalytics.GET("/risks", dashboardAnalyticsHandler.Risks)
